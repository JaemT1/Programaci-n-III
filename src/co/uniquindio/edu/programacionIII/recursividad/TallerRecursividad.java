...
//        }
// *****************************************************************************************************************************************************    
//    18) Escribir una función que reciba 2 enteros n y b y devuelva true si n es potencia de b. Ej. 16 es potencia de 2, 64 es potencia de 4, 50 no es potencia de 10.
//    public static boolean esPotencia(int base, int resultado) {
//        if (resultado / base > 1 && resultado % base == 0) {
//            return esPotencia(base, resultado / base);
//        } else if (resultado / base == 1) {
//            return true;
//            }
//        return false;
//        }
